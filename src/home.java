...
public class home extends javax.swing.JFrame {
   ...
   private  ImageIcon icon , icon2, icon3, icon4, icon5;
    ...
    private void location_combo_boxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_location_combo_boxActionPerformed
         ...
         {   try {
            img = ImageIO.read(new File("japan.jpg"));
         ...
         {   try {
            img = ImageIO.read(new File("singapore.jpg"));
         ...
         {   try {
            img = ImageIO.read(new File("australia.jpg"));
         ...
         {   try {
            img = ImageIO.read(new File("bangkok.jpg"));
         ...
         {   try {
            img = ImageIO.read(new File("berlin.jpg"));
